...
require("windowrules")
require("keybindings")
-- require() maps dots in module names to path separators, so "conf.d" is
-- unreachable through it; load the file directly instead.
dofile(os.getenv("HOME") .. "/.config/hypr/conf.d/voxtype-submap.lua")
