return {
    bg0 = "rgb(1F1F28)", -- sumiInk3       - Default background
    bg1 = "rgb(2A2A37)", -- sumiInk4       - Lighter background
    bg2 = "rgb(223249)", -- waveBlue1      - Visual selection / popup bg
    bg3 = "rgb(363646)", -- sumiInk5       - Cursorline / subtle highlight
    bg4 = "rgb(54546D)", -- sumiInk6       - Line numbers / float borders
    ...
    grey0 = "rgb(54546D)", -- sumiInk6       - Same as bg4, for consistency
