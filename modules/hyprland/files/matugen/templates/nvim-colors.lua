...
local p = {
  ...
  red    = "{{palettes.error._80.hex}}",
  orange = "{{palettes.tertiary._70.hex}}",
  yellow = "{{palettes.tertiary._90.hex}}",
  green  = "{{palettes.primary._80.hex}}",
  aqua   = "{{palettes.secondary._90.hex}}",
  blue   = "{{palettes.secondary._70.hex}}",
  purple = "{{palettes.primary._90.hex}}",
